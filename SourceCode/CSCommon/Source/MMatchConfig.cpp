...
bool MMatchConfig::Create()
{
	...
	else if (!stricmp(szServerMode, SERVER_CONFIG_SERVERMODE_TEST)) m_nServerMode = MSM_QUEST;

#ifdef _RELOADCONFIG
	m_bReloadSRV = (0 != GetPrivateProfileInt("SERVER", "RLDSERVER", 1, SERVER_CONFIG_FILENAME));
#endif
